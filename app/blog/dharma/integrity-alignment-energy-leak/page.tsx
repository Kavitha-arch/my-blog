    ...
    <BlogLayout>
      ...
      <article className="prose prose-neutral dark:prose-invert">
        ...
        <p>
          ...
          workers stayed passive. I tried to get others aligned. Instead of
        ...
        <h2>The hidden trap: trying to align others</h2>
        ...
        <blockquote>
          <p>
            I can see the truth without carrying the whole burden of correcting
            it.
          </p>
        </blockquote>
      </article>
