...
`,
    ...
    symbols: [
        ...
        "[TITLE] Three-Step Shift in Focus",
        "[INTRO]  A practical method to allow the Divine Energy (शक्ति, Śakti) to anchor within oneself.",
        ...
        "[HEADER] 2. INVOKE: Activating the Matrix (Durga)",
        "[BULLET] Activating the Matrix: In the myth, Brahma (ब्रह्मा) invokes Mahāmāyā (महामाया), the Divine Mother Durga (दुर्गा), to awaken Vishnu (विष्णु) from Yogic Sleep (योगनिद्रा, Yoganidrā). Internally, you are performing the same act—calling upon Divine Energy (शक्ति, Śakti) to awaken from unconscious reactivity.",
        "[BULLET] The Practice: Use a deliberate pattern interrupter.",
        "[BULLET] The Pivot: Take one deep breath and consciously align with your highest nature. If you use a mantra such as \"ॐ दुं दुर्गायै नमः,\" allow it to feel like a protective shield settling into place. If you ask, \"What would my highest self do?\", let the answer arise from clarity, steadiness, and conviction.",
        ...
        "Bridges the gap between theory and practice by pivoting the mind immediately from survival-mode to objective clarity.",
    ...
    reflection: [
        ...
        "The following 2 lines are from a book Devi by Ramesh Menon",
        "But she threw back her perfect head, and laughed. 'Gross Danava, I have not the faintest interest in pleasure. For I have eternal bliss, and what pleasure can compare with that? As for a man, the supreme Purusha is my Lord, how can I want any other, let alone you? Mahisha, seek your peace, for only peace will give you the joy you are seeking. '",
        "She said, 'Demon, I am only a witness in the world. I have no desire, and I am eternally free. I have no enmity with anyone, but when great evil rears its head I must crush it or the worlds would be plunged in darkness, and where will the good find refuge then? I have come to restore dharma, Daitya, for your evil master means to extinguish it forever.'"
